...
// #if (NET_4_6 || NET_STANDARD_2_0 || NETSTANDARD2_0_OR_GREATER || NETSTANDARD2_0)
...
namespace UniRx
{
    ...
    public static class TaskObservableExtensions
    {
        ...
        /// <remarks>If the specified task object supports cancellation, consider using <see cref="System.Reactive.Linq.Observable.FromAsync(Func{CancellationToken, Task})"/> instead.</remarks>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="task"/> is null.</exception>
        /// <remarks>If the specified task object supports cancellation, consider using <see cref="System.Reactive.Linq.Observable.FromAsync{TResult}(Func{CancellationToken, Task{TResult}})"/> instead.</remarks>
