...
{
    public abstract class UnityBase : IAsyncLifetime
    {
        protected readonly ITestOutputHelper Output;
        protected readonly IntegrationServerTestFixture Fixture;
        protected GraphQLHttpClient ChatClient;

        protected UnityBase(ITestOutputHelper output, IntegrationServerTestFixture fixture)
        {
            Output = output;
            Fixture = fixture;
        }
        ...
        {
            await ChatClient.InitializeWebsocketConnection(true);
